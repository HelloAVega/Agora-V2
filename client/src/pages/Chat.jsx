...
export default function Chat({ sessionId, onSessionChange, onCreateSession, onOpenSession }) {
  ...
  return (
    <div className="h-[calc(100dvh-2.75rem-env(safe-area-inset-bottom,0px))] min-h-[540px] flex flex-col bg-gradient-to-b from-purple-50 via-white to-indigo-50 rounded-none overflow-hidden">
      ...
      <div className="flex-1 min-h-0 flex flex-col bg-[radial-gradient(circle_at_top,_rgba(168,85,247,0.10),_transparent_38%)]">
        <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 sm:py-6 pb-0 space-y-4 scroll-pb-0">
          {loadingThread && (
        ...
        <form onSubmit={handleSubmit} className="border-t border-gray-200 bg-white/95 backdrop-blur-sm p-1.5 sm:p-2">
